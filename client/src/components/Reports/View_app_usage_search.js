...
import {
  ...
  setFilterMember,
  setFilterCompany,
} from '../../actions/appActivationActions';

const View_app_usage_search = ({
  setFilterStartDate,
  setFilterEndDate,
  setFilterName,
  setFilterMember,
...
View_app_usage_search.propTypes = {
  appActivations: PropTypes.object.isRequired,
};

const mapStateToProps = (state, props) => ({
  appActivations: state.appActivation,
});
